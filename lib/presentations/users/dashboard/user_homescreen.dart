...
import '../../admins/admin_announcments_list.dart';
...
class _UserDashboardScreenState extends State<UserDashboardScreen> {
  ...
  void initState() {
    ...
    adminController.fetchAnnouncements();
  }
                      ...
                      Container(
                        ...
                        child: DropdownButton<Fixture>(
                          items: fixtures.map((Fixture fixture) {
                            final team1 =
                                clubController.clubsTeamsData.firstWhere(
  ...
  Widget whatsNewSection() {
    return Obx(() {
      if (adminController.isLoading.value) {
        ...
        List<Announcement> announcements = adminController.announcements;
        return Container(
          margin: EdgeInsets.symmetric(vertical: 16.0, horizontal: 16.0),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        // Navigate to announcement details or perform other actions
...
//   Widget whatsNewSection() {
//     List<Announcement> articles = dummy;
//     return Container(
//       margin: EdgeInsets.symmetric(vertical: 16.0, horizontal: 16.0),
//       child: Column(
//         crossAxisAlignment: CrossAxisAlignment.start,
...
//             itemBuilder: (context, index) {
//               Announcement article = articles[index];
//               return Card(
//                 elevation: 2.0,
//                 margin: EdgeInsets.symmetric(vertical: 8.0),
//                 child: ListTile(
